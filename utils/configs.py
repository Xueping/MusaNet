...
class Configs(object):
    def __init__(self):
        ...
        parser.add_argument('--model_utils', type=str, default='tesa', help='tesa, vanila_sa, or cbow')
        ...
        parser.add_argument('--direction', type=str, default='None', help='None or Bi-Direction')
        ...
        #------------------path-------------------------------
        self.model_dir = self.mkdir(self.all_model_dir, self.task, self.model_utils)
        ...
        # self.log_name = self.get_params_str(['data_source', 'model_utils',
        #                  'max_epoch', 'train_batch_size',
        #                  'skip_window', 'num_samples',
        #                  'activation', 'is_scale',
        #                  'is_date_encoding', 'reduced_window'])
        # self.log_name = self.get_params_str(['data_source', 'model_utils', 'task_type',
        #                                      'max_epoch', 'train_batch_size', 'predict_type'])

        self.log_name = self.get_params_str(['data_source', 'model_utils', 'task_type', 'predict_type', 'direction',
                                             'activation', 'visit_threshold', 'pre_train'])
